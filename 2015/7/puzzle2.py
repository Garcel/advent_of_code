...
def puzzle2(input_file: typing.TextIO):
    ...
    process_input_file(input_file, circuit)

    a_value = circuit.get_wire_signals()['a']
    circuit.reset()
    circuit.execute(OperationKind.ASSIGN, 'b', f"{a_value}")
...
def process_input_file(input_file: typing.TextIO, circuit: Circuit):
